-- Add bimonthly (every 2 months) billing interval for workspace subscriptions.

alter table public.workspace_subscriptions
  drop constraint workspace_subscriptions_billing_interval_check;

alter table public.workspace_subscriptions
  add constraint workspace_subscriptions_billing_interval_check
  check (billing_interval in ('weekly', 'monthly', 'bimonthly', 'yearly'));
