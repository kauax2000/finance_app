-- WARNING: This will delete existing data in wallets, categories, transactions tables
-- Run this ONLY if you want to reset these tables
...
CREATE POLICY "Users can view own splits" ON transaction_splits FOR SELECT USING (true);
CREATE POLICY "Users can insert own splits" ON transaction_splits FOR INSERT WITH CHECK (true);
CREATE POLICY "Users can update own splits" ON transaction_splits FOR UPDATE USING (true);
CREATE POLICY "Users can delete own splits" ON transaction_splits FOR DELETE USING (true);
