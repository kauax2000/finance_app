...
export const REGISTRY: RegistryEntry[] = [
  ...
  entry("sheet", "Sheet", "Painel de borda no desktop, gaveta no telefone — uma API só, com um eixo que fixa o painel.", ui("sheet"), "Sheet, SheetContent, SheetTrigger, SheetClose"),
