...
export const REGISTRY: RegistryEntry[] = [
  ...
  entry("accordion", "Accordion", "Seções expansíveis, uma ou várias por vez.", ui("accordion"), "Accordion, AccordionItem"),
  entry("collapsible", "Collapsible", "Um bloco que expande e recolhe.", ui("collapsible"), "Collapsible, CollapsibleContent"),
  entry("hover-card", "Hover Card", "Prévia ao pousar o cursor. Nunca no telefone.", ui("hover-card"), "HoverCard, HoverCardContent"),
  ...
  entry("scroll-fade", "Scroll Fade", "Área rolável cujas bordas somem em gradiente.", ui("scroll-fade"), "ScrollFade"),
