    ...
    return (
        ...
        >
            ...
            {unreadCount > 0 ? (
                <span
                    className={cn(
                        "absolute top-0 right-0 z-10 flex h-4 min-w-4 translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full border-0 px-1 text-2xs font-semibold leading-none ring-2 ring-background",
                        tagChipUnreadCount
                    )}
                >
