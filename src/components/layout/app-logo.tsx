...
/**
 * O símbolo: o "f" caligráfico sozinho, num quadrado.
 *
 * Ele já montou o lockup — símbolo mais "Finance App" em Ledger, via um prop
 * `showWordmark`. O lockup agora é desenho pronto, `AppWordmark`, e o prop saiu
 * do tipo: com a palavra escrita à mão disponível, uma segunda maneira de
 * escrever o nome ao lado do símbolo só produz duas marcas ligeiramente
 * diferentes.
 *
 * O que sobra aqui é o que o lockup não faz: caber onde só há um quadrado.
 */
const LOGO_PATH =
